...
import type { AIProvider, AIMessage, AIResponse, StreamChunk } from '../../../services/ai/ai.types'
...
import { mockAIMessages, mockAIResponse, mockStreamChunks } from '../../fixtures'

function createMockProvider(name: string = 'openai'): AIProvider {
  return {
    name,
...
describe('AIService', () => {
  ...
  describe('constructor', () => {
    it('should require at least one provider', () => {
      expect(() => new AIService([])).toThrow('AIService requires at least one provider')
    })
  ...
  describe('complete', () => {
    ...
    it('should log and rethrow errors', async () => {
      ...
      ;(mockProvider.complete as ReturnType<typeof vi.fn>).mockRejectedValue(error)
  ...
  describe('stream', () => {
    ...
    it('should log and rethrow errors', async () => {
      ...
      ;(mockProvider.stream as ReturnType<typeof vi.fn>).mockImplementation(async function* () {
        throw error
      })
