...
describe('AppError', () => {
  describe('constructor', () => {
    it('should create error with all properties', () => {
      const error = new AppError(400, 'Bad Request', 'Invalid input', { field: 'email' }, {
    ...
    it('should extend Error class', () => {
      const error = new AppError(500, 'Internal Server Error', 'Something went wrong')
  ...
  describe('static factory methods', () => {
    describe('badRequest', () => {
      ...
      it('should include details when provided', () => {
        const error = AppError.badRequest('Validation failed', { fields: ['email', 'name'] })

        expect(error.details).toEqual({ fields: ['email', 'name'] })
      })

      it('should allow custom context', () => {
        const error = AppError.badRequest('Invalid', undefined, { operation: 'createUser' })
    ...
    describe('tooManyRequests', () => {
      ...
      it('should create 429 error with custom message', () => {
        const error = AppError.tooManyRequests('Rate limit exceeded for this endpoint')
...
describe('errorHandler', () => {
  ...
  describe('Fastify validation error handling', () => {
    ...
    it('should include validation details in response', () => {
      const validationDetails = [{ keyword: 'required', params: { missingProperty: 'email' } }]
      const error = {
        name: 'ValidationError',
        message: 'body.email is required',
