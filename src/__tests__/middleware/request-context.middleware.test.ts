...
describe('requestContextMiddleware', () => {
  ...
  describe('response header binding', () => {
    it('should set x-request-id header on response', async () => {
      ...
      expect(mockReply.header).toHaveBeenCalledWith('x-request-id', 'req-header-test')
    })
    ...
    it('should set x-correlation-id header on response', async () => {
      ...
      expect(mockReply.header).toHaveBeenCalledWith('x-correlation-id', 'corr-header-test')
    })
    ...
    it('should set both headers when correlation ID from header', async () => {
      ...
      expect(mockReply.header).toHaveBeenCalledWith('x-correlation-id', 'corr-both')
    })
    ...
    it('should use request ID for correlation header when no incoming correlation', async () => {
      ...
      expect(mockReply.header).toHaveBeenCalledWith('x-correlation-id', 'req-as-corr')
    })
  })
