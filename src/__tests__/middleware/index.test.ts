...
describe('Middleware Index', () => {
  ...
  describe('registerMiddlewareChain', () => {
    ...
    it('should register all middleware in the chain as preHandler hooks', () => {
      ...
      expect(mockInstance.addHook).toHaveBeenNthCalledWith(1, 'preHandler', mockMiddleware1)
      expect(mockInstance.addHook).toHaveBeenNthCalledWith(2, 'preHandler', mockMiddleware2)
      expect(mockInstance.addHook).toHaveBeenNthCalledWith(3, 'preHandler', mockMiddleware3)
    })
    ...
    it('should handle single middleware', () => {
      ...
      expect(mockInstance.addHook).toHaveBeenCalledWith('preHandler', mockMiddleware1)
    })
  })
