...
import { mockUser, mockChat, mockMessages } from '../fixtures'
...
describe('Chat Routes', () => {
  ...
  describe('GET /api/chats', () => {
    it('should call chatService.listChats with user id', async () => {
      ...
      expect(mockChatService.listChats).toHaveBeenCalledWith(
        mockUser.id,
        { limit: undefined, offset: undefined, page: undefined }
      )
    })
  ...
  describe('GET /api/chats/:chatId/history', () => {
    ...
    it('should return chat history', async () => {
      ...
      const result = await mockChatService.getChatHistory(mockChat.id, mockUser.id)
