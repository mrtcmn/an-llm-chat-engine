...
import { type EnvConfig, envSchema, validateEnv } from "./env.config";
import { type FeatureFlags, featureFlagsSchema } from "./feature-flags.schema";
...
export { featureFlagsSchema, type FeatureFlags };
