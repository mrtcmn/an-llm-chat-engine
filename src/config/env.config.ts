...
export const envSchema = z.object({
  ...
  DB_CONNECTION_TIMEOUT: z.coerce
    .number()
    .default(DATABASE.DEFAULT_CONNECTION_TIMEOUT),
  ...
  DB_MAX_RETRY_ATTEMPTS: z.coerce
    .number()
    .default(DATABASE.DEFAULT_MAX_RETRY_ATTEMPTS),
  DB_RETRY_BASE_DELAY: z.coerce
    .number()
    .default(DATABASE.DEFAULT_RETRY_BASE_DELAY),

  // Database Health Check - environment-specific behavior
  DB_HEALTH_CHECK_INTERVAL: z.coerce
    .number()
    .default(DATABASE.DEFAULT_HEALTH_CHECK_INTERVAL),
  ...
  PAGINATION_LIMIT: z.coerce.number().min(10).max(100).default(20),
